...
export const LEADER_APARTMENTS: LeaderEntry[] = [
  ...
  // ── 서울 광진구 ─────────────────────────────────────────────
  { region: "서울 광진구", name: "e편한세상광진그랜드파크", address: "서울특별시 광진구 구의동 238", brand: "e편한세상", households: 730 },
  // ── 서울 노원구 ─────────────────────────────────────────────
  ...
  // ── 서울 중랑구 ─────────────────────────────────────────────
  { region: "서울 중랑구", name: "사가정센트럴아이파크", address: "서울특별시 중랑구 면목동 1-1", brand: "아이파크", households: 1505 },
  // ── 서울 강서구 ─────────────────────────────────────────────
  ...
  // ── 경기 안양시 ─────────────────────────────────────────────
  { region: "경기 안양시 동안구", name: "비산삼성래미안", address: "경기도 안양시 동안구 비산동 397", brand: "래미안", households: 3806 },
  ...
  // ── 경기 시흥시 ─────────────────────────────────────────────
  { region: "경기 시흥시", name: "시흥배곧SK뷰", address: "경기도 시흥시 배곧동 135", brand: "SK뷰", households: 1442 },
  // ── 경기 김포시 ─────────────────────────────────────────────
  ...
  // ── 경기 안산시 ─────────────────────────────────────────────
  { region: "경기 안산시", name: "안산레이크타운푸르지오", address: "경기도 안산시 단원구 고잔동 782", brand: "푸르지오", households: 1569 },
  // ── 경기 부천시 ─────────────────────────────────────────────
  ...
  // ── 경기 의왕시 ─────────────────────────────────────────────
  { region: "경기 의왕시", name: "인덕원센트럴자이", address: "경기도 의왕시 내손동 770", brand: "자이", households: 2540 },
  // ── 경기 광주시 ─────────────────────────────────────────────
  ...
  // ── 인천 계양구 ──────────────────────────────────────────────
  { region: "인천 계양구", name: "e편한세상계양더프리미어", address: "인천광역시 계양구 효성동 677", brand: "e편한세상", households: 1646 },
];
