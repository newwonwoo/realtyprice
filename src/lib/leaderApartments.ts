...
export const LEADER_APARTMENTS: LeaderEntry[] = [
  ...
  // ── 서울 광진구 ─────────────────────────────────────────────
  { region: "서울 광진구", name: "e편한세상광진그랜드파크", address: "서울특별시 광진구 구의동 680", brand: "e편한세상", households: 730, complexPk: "11215120431558" },
  // ── 서울 노원구 ─────────────────────────────────────────────
  ...
  // ── 서울 성북구 ─────────────────────────────────────────────
  { region: "서울 성북구", name: "길음뉴타운래미안9단지", address: "서울특별시 성북구 길음동 1286", brand: "래미안", households: 1012, complexPk: "11290120131669" },
  // ── 서울 종로구 ─────────────────────────────────────────────
  ...
  // ── 서울 구로구 ─────────────────────────────────────────────
  { region: "서울 구로구", name: "영등포아트자이", address: "서울특별시 영등포구 도림동 821", brand: "자이", households: 836, complexPk: "11560120287491" },
  // ── 서울 금천구 ─────────────────────────────────────────────
  { region: "서울 금천구", name: "금천롯데캐슬골드파크1차", address: "서울특별시 금천구 독산동 1147", brand: "롯데캐슬", households: 1743, complexPk: "11545120344418" },
  // ── 서울 영등포구 ────────────────────────────────────────────
  { region: "서울 영등포구", name: "영등포아트자이", address: "서울특별시 영등포구 도림동 821", brand: "자이", households: 836, complexPk: "11560120287491" },
  // ── 서울 동작구 ─────────────────────────────────────────────
  { region: "서울 동작구", name: "아크로리버하임", address: "서울특별시 동작구 흑석동 341", brand: "아크로", households: 1073, complexPk: "11590120381797" },
  // ── 서울 관악구 ─────────────────────────────────────────────
  { region: "서울 관악구", name: "관악드림타운", address: "서울특별시 관악구 봉천동 1712", brand: "동아·삼성물산", households: 3544, complexPk: "11620100002112" },
  ...
  { region: "경기 고양시 덕양구", name: "DMC한강자이더헤리티지", address: "경기도 고양시 덕양구 덕은동 679", brand: "자이", households: 620, complexPk: "41281120441148" },
  // ── 경기 파주시 ─────────────────────────────────────────────
  { region: "경기 파주시", name: "힐스테이트더운정", address: "경기도 파주시 목동동 1149", brand: "힐스테이트", households: 2998, complexPk: "41480120373331" },
  // ── 경기 안양시 ─────────────────────────────────────────────
  { region: "경기 안양시 동안구", name: "비산삼성래미안", address: "경기도 안양시 동안구 비산동 425", brand: "래미안", households: 3806, complexPk: "41173100051252" },
  ...
  // ── 경기 안산시 ─────────────────────────────────────────────
  { region: "경기 안산시", name: "안산레이크타운푸르지오", address: "경기도 안산시 단원구 고잔동 782", brand: "푸르지오", households: 1569, complexPk: "41273120332279" },
  // ── 경기 부천시 ─────────────────────────────────────────────
  ...
  // ── 경기 의왕시 ─────────────────────────────────────────────
  { region: "경기 의왕시", name: "인덕원센트럴자이", address: "경기도 의왕시 내손동 844", brand: "자이", households: 1354, complexPk: "41430120124602" },
  // ── 경기 광주시 ─────────────────────────────────────────────
  ...
  // ── 인천 서구(청라) ───────────────────────────────────────────
  { region: "인천 서구", name: "청라더샵레이크파크", address: "인천 서구 청라동", brand: "더샵", households: 0 },
  // ── 인천 남동구 ──────────────────────────────────────────────
  { region: "인천 남동구", name: "구월힐스테이트1단지", address: "인천광역시 남동구 구월동 23", brand: "힐스테이트", households: 5076, complexPk: "28200120072066" },
  // ── 인천 부평구 ──────────────────────────────────────────────
